...
a1n100o1pr25_rects <- simulateLearnerGuesses(observations, alpha = 1, trial = 1, nRectangles = 100, prior = "normal")
a1n100o1_pr25posteriors <- getMultiAlphaPosteriors(learnerRectangles = a1n100o1_rects, observations, prior = "normal")
