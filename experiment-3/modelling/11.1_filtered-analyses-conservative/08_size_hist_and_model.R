...
for (i in 1:length(all_conditions_filtered[, 1])) {
  ...
  if (condition == "US" | condition == "UN") {
    sizeHistModel(d_all_sizes, condition, plotCond, prob_constant = 50, ylim = 30)
  } else {
    sizeHistModel(d_all_sizes, condition, plotCond, prob_constant = 200, ylim = 30)
  }
  ggsave(filename = here(
    paste0(
      "experiment-3/modelling/11.1_filtered-analyses-conservative/plots/size_hist_b8_c",
      c,
      "_",
      condition,
      ".png"
