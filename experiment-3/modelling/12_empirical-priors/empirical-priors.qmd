...
ggpubr::ggarrange(plot_list[["HS"]], plot_list[["MS"]], plot_list[["US"]], plot_list[["RS"]], labels = c("Helpful", "Misleading Naive", "Misleading Aware", "Random"), label.x = 0.2, nrow = 1, common.legend = TRUE, legend = "bottom")

ggsave(filename = here("experiment-3/modelling/12_empirical-priors/plots/size-hist-priors.png"), width = 13, height = 5)
