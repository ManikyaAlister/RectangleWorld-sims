...
dir.create(here(paste0("model-demonstrations/figures/tlpairs/",dirname,"/")))
```
...
ggsave(paste0("model-demonstrations/figures/tlpairs/",dirname,"/priors.png"),
       plot=p,device="png",
...
ggsave(paste0("model-demonstrations/figures/tlpairs/",dirname,"/step1.png"),
       plot=pt1,device="png",
...
ggsave(paste0("model-demonstrations/figures/tlpairs/",dirname,"/step2.png"),
       plot=pt2,device="png",
       width=36,height=15, units="cm")
...
ggsave(paste0("model-demonstrations/figures/tlpairs/",dirname,"/step3.png"),
       plot=pt3,device="png",
       width=36,height=15, units="cm")
...
ggsave(paste0("model-demonstrations/figures/tlpairs/",dirname,"/step4.png"),
       plot=pt4,device="png",
       width=36,height=15, units="cm")
...
filename = paste0("model-demonstrations/results/",dirname,".RData")
