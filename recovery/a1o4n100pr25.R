...
a1n100o4pr25_rects <- simulateLearnerGuesses(observations, alpha = 1, trial = 4, nRectangles = 100, prior = "normal")
a1n100o4pr25_posteriors <- getMultiAlphaPosteriors(learnerRectangles = a1n100o4pr25_rects, observations, prior = "normal")

save(a1n100o4pr25_posteriors, file = here("recovery/data/a1n100o4pr25.RData"))