...
createExperimentBlock = function(trueRectSize = "small",
 ...
 ## List with all block information relevent for experiment 
 ...
 ## wrangle into format that will work for the experiment
 blockData[["observations"]][,"x"] <-  blockData[["observations"]][,"x"] + 0.5
 blockData[["observations"]][,"y"] <-  blockData[["observations"]][,"y"] + 0.5
