...
# load data 
load(here("experiment-2/data/clean/clean_data.rdata"))
...
save(d_cartesian, file = here("experiment-2/data/derived/data_cartesian.Rdata"))
...
save(all_conditions, file = here("experiment-2/data/derived/all_conditions.Rdata"))
