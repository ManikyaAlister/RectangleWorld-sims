...
ggsave(filename = "experiment-2/modelling/05_plots/size-hist-tb2-sf.png", plot = sizeHistTb2, height = 15, width = 15)

sizeHistTb8 <- sizeHist(tb8)
ggsave(filename = "experiment-2/modelling/05_plots/size-hist-tb8-sf.png", plot = sizeHistTb8, height = 15, width = 15)

sizeHistTb8Mc <- sizeHist(tb8mc)
ggsave(filename = "experiment-2/modelling/05_plots/size-hist-tb8-mc-sf.png", plot = sizeHistTb8Mc, height = 15, width = 15)

sizeHistTb8McCs <- sizeHist(tb8mcCs)
ggsave(filename = "experiment-2/modelling/05_plots/size-hist-tb8-mc-cover-sf.png", plot = sizeHistTb8McCs, height = 15, width = 15)
