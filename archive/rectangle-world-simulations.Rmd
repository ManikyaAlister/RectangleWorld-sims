...
***transparency of block corresponds to probability***
...
The above plots aren't great at showing which triangle is most likely because when the rectangles overlap it inflates how probable a rectangle appears. 

What about just showing the highest probability rectangle? Main problem with this is it doesn't really show the uncertainty or distribution of possible rectangles, but it will do a better job of showing differences between models. 
...
Other model: just outside points are considered. 

For debugging maybe make it a smaller grid? Much less hypothesis. Can think about how probable each hypothesis is myself. 

Check to make sure trade off between size of the positive and size of the negative hypotheses. 

Code alpha into the model 
...
plotPed(strong1Neg,obs1Neg,cat1)
#plotPed(strong1Pos,obs1Pos,cat1)
