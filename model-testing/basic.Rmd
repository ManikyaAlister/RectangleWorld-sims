...
pPos <- plotDistribution(allPts=initPtsPos,xrange=xrange,yrange=yrange,
                         subtitle="Positive hypotheses",
                         title="Initial distribution")
pNeg <- plotDistribution(allPts=initPtsNeg,xrange=xrange,yrange=yrange,
                         subtitle="Negative hypotheses",
                         title="Initial distribution")
pAll <- plotDistribution(allPts=initPtsAll,xrange=xrange,yrange=yrange,
...
ggsave(paste0("model-testing/figures/basic/initialDist",fileSeg,".png"),
       plot=p,device="png",
...
ggsave(paste0("model-testing/figures/basic/trueHypotheses",fileSeg,".png"),
       plot=p,device="png",
       width=24,height=8, units="cm")
...
ggsave(paste0("model-testing/figures/basic/firstPoints",fileSeg,".png"),
       plot=ps,device="png",
...
ggsave(paste0("model-testing/figures/basic/firstPointsOpposite",fileSeg,".png"),
       plot=ps,device="png",
