...
ggsave(plot = tb2_posteriors, filename = here("experiment-1/modelling/05_plots/tb2_posteriors_median.png"), height = 10, width = 12)
...
tb2_posteriors <- ggarrange(plotlist = all_plots, ncol = 4, nrow = 32/4)
ggsave(plot = tb2_posteriors, filename = here("experiment-1/modelling/05_plots/tb2_posteriors_mean.png"), height = 10, width = 12)
...
ggsave(plot = tb8_posteriors, filename = here("experiment-1/modelling/05_plots/tb8_posteriors_median.png"), height = 10, width = 12)
