...
posteriors <- getMultiAlphaPosteriors(learnerRectangles = d_cond, observations = observations, prior = "normal")

save(posteriors, file = here(paste0("experiment-1/modelling/04_output/",cond,"-clue",clue,"-tb",tb,"-post.Rdata")))
