...
save(all_conditions, file = here("experiment-1/data/derived/all_conditions.Rdata"))
...
for (i in 1:length(all_conditions[,1])){
  ...
  save(d_cond, file = here(paste0("experiment-1/data/derived/",cond,"-clue-",clue,"-tb-",tb,".Rdata")))
}
