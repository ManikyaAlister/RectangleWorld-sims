...
What about for another set of responses? Responses that weren't as aligned with how a helpful provider would choose points? 
...
```{r}
plotHypPosteriorDistBySize = function(hypDist, trial){
  learner = hypDist[[trial]]
  sizeOrderedIndex <- order(learner[,"size"], decreasing = TRUE)
  sizeOrdered <- learner[sizeOrdered,"size"]
}
```
