...
a1o1 <- hypHist(observations, alpha = 1, trial = 1, nRectangles = 100, prior = "flat"),
a0o1 <- hypHist(observations, alpha = 0, trial = 1, nRectangles = 100, prior = "flat"),
aNeg1o1 <- hypHist(observations, alpha = -1, trial = 1, nRectangles = 100, prior = "flat"),

a1o2 <- hypHist(observations, alpha = 1, trial = 2, nRectangles = 100, prior = "flat"),
a0o2 <- hypHist(observations, alpha = 0, trial = 2, nRectangles = 100, prior = "flat"),
aNeg1o2 <- hypHist(observations, alpha = -1, trial = 2, nRectangles = 100, prior = "flat"),

a1o3 <- hypHist(observations, alpha = 1, trial = 3, nRectangles = 100, prior = "flat"),
a0o3 <- hypHist(observations, alpha = 0, trial = 3, nRectangles = 100, prior = "flat"),
aNeg1o3 <- hypHist(observations, alpha = -1, trial = 3, nRectangles = 100, prior = "flat"),

a1o4 <- hypHist(observations, alpha = 1, trial = 4, nRectangles = 100, prior = "flat"),
a0o4 <- hypHist(observations, alpha = 0, trial = 4, nRectangles = 100, prior = "flat"),
aNeg1o4 <- hypHist(observations, alpha = -1, trial = 4, nRectangles = 100, prior = "flat")
)
...
```{r}
library(patchwork)
load(here("recovery/data/a-1Alln100Flat.Rdata"))
pNeg1 <-  plotMeanPosteriorAlphas(posteriorsAlphas = posteriors, generatingAlpha = -1, recovery = TRUE, stat = "mean")
load(here("recovery/data/a0Alln100Flat.Rdata"))
p0 <- plotMeanPosteriorAlphas(posteriorsAlphas = posteriors, generatingAlpha = 0, recovery = TRUE, stat = "mean")
load(here("recovery/data/a1Alln100Flat.Rdata"))
p1 <- plotMeanPosteriorAlphas(posteriorsAlphas = posteriors, generatingAlpha = 1, recovery = TRUE, stat = "mean")
